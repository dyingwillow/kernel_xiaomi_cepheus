...
KERNEL_BOOTIMAGE_CMDLINE = console=ttyMSM0,115200n8 earlycon=msm_geni_serial,0xa90000 androidboot.hardware=qcom androidboot.console=ttyMSM0 androidboot.memcg=1 lpm_levels.sleep_disabled=1 video=vfb:640x400,bpp=32,memsize=3072000 msm_rtb.filter=0x237 service_locator.enable=1 swiotlb=2048 loop.max_part=7 androidboot.usbcontroller=a600000.dwc3 buildvariant=user console=tty0 droidian.lvm.prefer
...
DEVICE_MODEL = cepheus

# Marketing-friendly full-name. This will be used inside package descriptions
DEVICE_FULL_NAME = Xiaomi Mi 9

# Defconfig to use
KERNEL_DEFCONFIG = vendor/halium-cepheus_defconfig
...
KERNEL_BOOTIMAGE_INITRAMFS_OFFSET = 0x00000000
...
# recommended.
FLASH_INFO_CPU = Qualcomm Technologies, Inc ugly
